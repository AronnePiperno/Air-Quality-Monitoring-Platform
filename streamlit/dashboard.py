...
def display_data():
    ...
    if "Overall" in selected_values:
        ...
        aqi_value = int(response.json()["AQI"])
        ...
        a1.write(
            f"<p style='color:#00000; font-family: Workhorse Regular, sans-serif; text-align: center;'>The Air Quality is <strong>{quality}</strong>",
            unsafe_allow_html=True)
        a1.write("")
        ...
        a6.markdown(container_html, unsafe_allow_html=True)

        # Description

        a1.markdown("""
        <div style="font-family: Workhorse Regular sans-serif; text-align: justify;">
            AQI (Air Quality Index) is a numerical scale used to communicate daily air pollution levels to the public. It helps individuals make informed decisions to safeguard their health and reduce exposure to harmful pollutants.
        </div>
        """, unsafe_allow_html=True)
