...
def city_selection():
    ...
    # Set up
    st.markdown("<h1 style='color:#00000; font-size: 40px; font-family: Workhorse, sans-serif;'>City Selection</h1>", unsafe_allow_html=True)
...
def display_data():
    ...
    st.write("<p style='color:#00000; font-family: Workhorse Regular, sans-serif;'><strong>City:</strong> " + str(location) + "</p>", unsafe_allow_html=True)
    ...
    selected_values = st.selectbox("Select the pollutant you are looking for:", (["HCHO", "NO2", "O3", "SO2", "Overall", "CO"]))


    # Overall
    if "Overall" in selected_values:

        a1,a2,a3,a4,a5,a6=st.columns(6, gap="medium")
        a1.markdown("<h2 style='text-align: center; font-family: Workhorse Rough, sans-serif;'>CH4</h2>", unsafe_allow_html=True)
        a1.markdown("""
        ...
        """, unsafe_allow_html=True)
        a2.markdown("<h2 style='text-align: center; font-family: Workhorse Rough, sans-serif;'>CO</h2>", unsafe_allow_html=True)
        a2.markdown("""
        <div style="font-family: Workhorse Regular sans-serif;">
        ...
        """, unsafe_allow_html=True)
        a3.markdown("<h2 style='text-align: center; font-family: Workhorse Rough, sans-serif;'>HCHO</h2>", unsafe_allow_html=True)
        a3.markdown("""
        <div style="font-family: Workhorse Regular sans-serif;">
        ...
        """, unsafe_allow_html=True)
        a4.markdown("<h2 style='text-align: center; font-family: Workhorse Rough, sans-serif;'>NO2</h2>", unsafe_allow_html=True)
        a4.markdown("""
        <div style="font-family: Workhorse Regular sans-serif;">
        ...
        """, unsafe_allow_html=True)
        a5.markdown("<h2 style='text-align: center; font-family: Workhorse Rough, sans-serif;'>O3</h2>", unsafe_allow_html=True)
        a5.markdown("""
        <div style="font-family: Workhorse Regular sans-serif;">
        ...
        """, unsafe_allow_html=True)
        a6.markdown("<h2 style='text-align: center; font-family: Workhorse Rough, sans-serif;'>SO2</h2>", unsafe_allow_html=True)
        a6.markdown("""
        <div style="font-family: Workhorse Regular sans-serif;">
        ...
        b1.markdown(
            """
            <div style='display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 20px; border-radius: 10px; border: 1px solid black; margin-top: 40px;font-family: Workhorse, sans-serif;'>
    ...
    if "CO" in selected_values:
        ...
        if len(values_CO)==0:
            ...
            city_2nd = st.text_input(f"Do you want to compare {city} with another city?")
            if st.form(key='city_form'):
                # Validate city input
                if city_2nd.strip():
                    geolocator = Nominatim(user_agent="your_app_name")
                    city_2nd = geolocator.geocode(city)
                    if location is None:
                        st.error("I'm sorry, I could not find this city!")
                    else:
    ...
    if "HCHO" in selected_values:
        ...
        if len(values_HCHO)==0:
            ...
            st.pyplot(graph_setup(df_HCHO, values_HCHO, dates_HCHO, "L2__HCHO__")[0])
            st.write("")
            city = location.raw['display_name'].split(", ")[0]
            city_2nd = st.text_input(f"Do you want to compare {city} with another city?")
    ...
    if "NO2" in selected_values:
        ...
        if len(values_NO2)==0:
            ...
            st.pyplot(graph_setup(df_NO2, values_NO2, dates_NO2, "L2__NO2___")[0])
            st.write("")
            city = location.raw['display_name'].split(", ")[0]
            city_2nd = st.text_input(f"Do you want to compare {city} with another city?")
    ...
    if "O3" in selected_values:
        ...
        if "mean_O3" not in locals():
            mean_O3, values_O3, dates_O3 = kpis(latitude,longitude,"L2__O3__")
        ...
        if len(values_O3)==0:
            ...
            st.pyplot(graph_setup(df_O3, values_O3, dates_O3, "L2__O3__")[0])
            st.write("")
            city = location.raw['display_name'].split(", ")[0]
            city_2nd = st.text_input(f"Do you want to compare {city} with another city?")       
    ...
    if "SO2" in selected_values:
        ...
        if len(values_SO2)==0:
            ...
            st.pyplot(graph_setup(df_SO2, values_SO2, dates_SO2, "L2__SO2___")[0])
            st.write("")
            city = location.raw['display_name'].split(", ")[0]
            city_2nd = st.text_input(f"Do you want to compare {city} with another city?") 
